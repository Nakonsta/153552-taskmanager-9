...
const getTaskCardTemplate = ({description, dueDate, repeatingDays, tags, color, isFavorite, isArchive}) => {
            ...
            <div class="card__inner">
                ...
                <div class="card__details">
                    ...
                    <div class="card__date-deadline">
                        ...
                        <span class="card__time"${new Date(dueDate).toTimeString()}</span>
                        </p>
                    </div>
                    </div>

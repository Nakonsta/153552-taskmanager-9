(function(){
  ...
  renderComponent(menuContainer, returnMenu);
  renderComponent(mainContainer, returnSearch);
  renderComponent(mainContainer, returnFilters);
  renderComponent(tasksContainerInner, returnTaskEdit);
  for (let i = 0; i < 3; i++) {
    renderComponent(tasksContainerInner, returnTaskCard);
  }
  mainContainer.appendChild(tasksContainer);
  renderComponent(tasksContainer, returnLoadBtn);
